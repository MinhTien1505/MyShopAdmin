            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col mt-15 mb-15">
                    ...
                    <div class="header-logo">
                        <a href="/shop">
                            <img src="assets/Shop/images/logo.png" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template">
                            <img class="theme-dark" src="assets/Shop/images/logo-light.png" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template">
                        </a>
                    </div><!-- Logo End -->
                </div>
                                ...
                                <li class="menu-item-has-children"><a href="shop-grid.html">Shop</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item-has-children"><a href="/">Single Product</a>
                                            <ul class="sub-menu">
                                                <li><a href="/">Single Product 1</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
