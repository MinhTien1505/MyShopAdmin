    ...
    <div class="container-fluid">
        ...
        <v-container class="grey lighten-5">
            <v-row class="mb-6 p-3" no-gutters data-app style="justify-content: center !important">
                ...
                <v-col md="auto">
                    <v-btn @click="confirm(order._id, 'Approved')"
                            :dark="order.status == 'Pending'" color="#F62D51"
                ...
                <v-col md="auto">
                    <v-btn @click="confirm(order._id, 'Cancel')"
                            :dark="order.status == 'Pending'" color="#899878"
                            :disabled="order.status != 'Pending'">
                ...
                <v-col md="auto">
                    <v-btn @click="confirm(order._id, 'Delivery')"
                            color="#EACE2A"
